...
namespace Anusca_David_Lab2.Data
{
    public class Anusca_David_Lab2Context : DbContext
    {
        ...
        public DbSet<Anusca_David_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Anusca_David_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Anusca_David_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
